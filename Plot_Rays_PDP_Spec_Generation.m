function [k_Rice, RMS_T, TT_N,PP_N]=Plot_Rays_PDP_Spec_Generation(handles)
%INPUTS
%insert the dimensions of the receiver position. 
% rx=find(X==39 & Y==10 & Z==1.5);
% % rx=find(X==14.5 & Y==25 & Z==1.5);
